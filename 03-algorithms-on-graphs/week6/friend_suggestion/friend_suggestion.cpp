...
///
/// Intro: In this task you will be given a description of a real-world road network with not just edges and their
///        lengths, but also with the coordinates of the nodes. Your task is still to find the distance between some
///        pairs of nodes, but you will need to use the additional information about coordinates to speedup your search.
